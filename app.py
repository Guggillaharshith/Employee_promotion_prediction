...
data_file = Path(__file__).resolve().parent / "employee_promotion_dataset.csv"
if not data_file.exists():
    st.error(
        "Dataset file not found. Please make sure employee_promotion_dataset.csv is in the same folder as app.py."
    )
    st.stop()
